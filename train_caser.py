...
class Recommender(object):
    ...
    def predict(self, user_id, item_ids=None):
        ...
        self._net.eval()
        with torch.no_grad():
            #print(self.test_sequence.sequences[user_id, :])
...
if __name__ == '__main__':
    ...
    # data arguments
    parser.add_argument('--train_root', type=str, default='D:/caser_pytorch-master/caser_pytorch-master/datasets/amazon3/test/train.txt')
    parser.add_argument('--test_root', type=str, default='D:/caser_pytorch-master/caser_pytorch-master/datasets/amazon3/test/test.txt')
...
#len(train.user_ids)
'''
for i in  train.user_ids:
    if(i not in range(8035)):
        print(i)
'''    
